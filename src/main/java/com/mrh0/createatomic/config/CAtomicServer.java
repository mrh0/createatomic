...
public class CAtomicServer extends ConfigBase {
    ...
    public final ConfigFloat turbineCapacity = f(2.0f, 0.1f, 1024f, "turbineCapacity",
            "Stress capacity (SU per RPM) generated by the Steam Turbine.",
            "Default 2.0 means two turbines are needed to absorb one effective power unit.");
