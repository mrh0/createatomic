...
The reactor is a multiblock built from **Reactor Casing** blocks (square base,
...
Placed on any **face of a reactor casing**. Controls whether the reactor can
run.
...
Steam Turbines attach to the **sides** of the reactor and chain inline. Each
